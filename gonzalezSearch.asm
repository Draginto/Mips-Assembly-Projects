...
getNumbers:
	...
	pushToArray:
		...
		li $v0, 5
		syscall 		# Get the user's choice of num.
		
		sw $v0, 0($a1)		# Store the word in the register.
...
searchArray:
	...
	sequentialSearch:
		beq $t2, $t4, cancelSearch
		
		beq $t1, $t5, elemNotFound
		lw $t3, 0($a1)		# Load the word in the register.
...
searchfor: .asciiz "Enter number to search for(-9999 to exit): "
